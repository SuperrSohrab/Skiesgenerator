...
public class GeneratorInteractionMenu {
    ...
    public GeneratorInteractionMenu(Plugin plugin, Generator generator) {
        this.plugin = plugin;
        this.generator = generator;
        this.inventory = Bukkit.createInventory(null, 27, ChatColor.DARK_GRAY + "Generator Options");
        populateMenu();
    ...
    private void populateMenu() {
        ...
        inventory.setItem(11, upgradeItem);

        // Take generator button (for block-mode)
